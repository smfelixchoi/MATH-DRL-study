...
plt.savefig('/mnt/prj/CSM/MATH-DRL-study/3.DQN-2/'+fig_title, bbox_inches='tight')
plt.close()
...
## Expected SARSA
env = gym.make('CartPole-v1')
agent = Expected_SARSA_Agent(input_shape=env.observation_space.shape, 
                             num_actions=env.action_space.n,
                             gamma=0.99,
                             epsilon=1,
                             epsilon_decay=0.999,
