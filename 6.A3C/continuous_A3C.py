...
class Net(nn.Module):
    def __init__(self, s_dim, a_dim):
        ...
        self.mu = nn.Linear(32, a_dim)
        self.sigma = nn.Linear(32, a_dim)
    ...
    def run(self):
        ...
        while self.g_ep.value < MAX_EP:
            ...
            for t in range(MAX_EP_STEP):
                ...
                buffer_a.append(a)
                buffer_s.append(s)
                buffer_r.append((r+8.1)/8.1)    # normalize(total reward can be -16.2xxx ~ 0)
...
if __name__ == "__main__":
    ...
    res = np.array(res)
    np.save("continuous_result.npy", res)
    plt.plot(res)
